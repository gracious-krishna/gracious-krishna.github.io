    ...
    return {
      ...
      skills: [
        ...
        },
        {
          ...
          contentList: [
            { cardContent: '.Net: C#, WPF, ASP.Net Web Forms, ASP.Net Core, Web API, Testing.' },
            ...
            { cardContent: 'Python: Flask, Django.' },
          ], id: 2
        },
        {
        ...
        },
        {
          ...
          contentList: [
            ...
            { cardContent: 'C#, JavaScript, Java, Python, C++, C.' },
          ], id: 4
        },
      ],
      ...
      jobs: [
        {
          ...
          contentList: [
            { cardContent: '- React, JavaScript, Nodejs, Java, Spring Boot, Kafka, JUnit, Mockito, Usergrid, Jenkins, Docker, Git.' },
        ...
        },
        {
          ...
          contentList: [
            { cardContent: '- C#, ASP.Net, Java, PHP.' },
        ...
        },
        {
          ...
          contentList: [
            { cardContent: '- Python, Hadoop, Amazon web server.' },
